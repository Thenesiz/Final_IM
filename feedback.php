...
<head>
    ...
    <style>
        /* Inline CSS to ensure the header displays correctly */
        .feedback-header {
            text-align: center;
            margin-top: -50px;
            margin-bottom: 20px;
...
<div class="feedback-container">
    ...
    <div class="feedback-header">
        ...
        <p>Your thoughts and suggestions help us improve. Please share your experience with us!</p>
    </div>
    ...
    <div class="feedback-textbox-wrapper">
        ...
        <?php if ($message != ''): ?>
            <script>
                showNotification('<?php echo $message; ?>', <?php echo $message !== 'Thank you for sharing your valuable feedback!' ? 'true' : 'false'; ?>);
            </script>
        <?php endif; ?>
    </div>
